...
function GoogleMark() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      <path
        d="M44 24c0-1.4-.1-2.7-.4-4H24v8h11.3a9.7 9.7 0 0 1-4.2 6.3v5.2h6.8C41.9 35.8 44 30.4 44 24Z"
        fill="#4285F4"
      />
      <path
        d="M24 45c5.7 0 10.4-1.9 13.9-5.1l-6.8-5.2A12.6 12.6 0 0 1 24 36.5c-5.5 0-10.1-3.7-11.8-8.6H5.2v5.4A21 21 0 0 0 24 45Z"
        fill="#34A853"
      />
      <path d="M12.2 27.9a12.5 12.5 0 0 1 0-7.9v-5.4H5.2a21 21 0 0 0 0 18.7l7-5.4Z" fill="#FBBC05" />
      <path
        d="M24 11.5c3.1 0 5.9 1.1 8.1 3.2l6-6A21 21 0 0 0 5.2 14.6l7 5.4c1.7-4.9 6.3-8.5 11.8-8.5Z"
        fill="#EA4335"
      />
    </svg>
  );
