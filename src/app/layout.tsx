  ...
  return (
    ...
    >
      <body>
        <a
          href="#workspace"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus: focus:bg-ink focus:px-4 focus:py-2 focus:text-text-inverse"
        >
          Skip to content
        </a>
