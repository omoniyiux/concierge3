...
const TOPICS = [
  {
    Icon: InstallIcon,
    title: "Installing Concierge",
    body: "The script, platform guides and what to do when it is not detected.",
  },
  {
    Icon: BrainIcon,
    title: "Site Brain",
    body: "How Concierge learns, what approval means, and how to fix a wrong answer.",
  },
  {
    Icon: RoutingIcon,
    title: "Routing",
    body: "Destinations, rules, testing a route and reading delivery history.",
  },
  {
    Icon: CodeIcon,
    title: "Developers",
    body: "The API, webhook payloads and building your own integration.",
  },
];
  ...
  return (
    <div className="min-h-dvh bg-canvas">
      ...
      <main className="mx-auto w-full max-w-[900px] px-5 py-14 lg:px-8">
        ...
        <p className="t-body mt-3 max-w-[52ch] text-text-primary">
