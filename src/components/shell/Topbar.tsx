  ...
  return (
    <header className="flex h-[var(--topbar-h)] shrink-0 items-center gap-2 border-b border-line bg-surface px-3 lg:px-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="hidden items-center gap-1.5 rounded-md px-2 py-1 text-[12.5px] text-text-tertiary transition-colors hover:bg-surface-subtle hover:text-text-primary md:inline-flex"
      >
        {site.url}
      ...
      <button
        ...
        className={cx(
          "ml-auto flex h-8 items-center gap-2 rounded-lg border border-line bg-surface-subtle pl-2.5 pr-2 text-text-muted",
      ...
      >
        ...
        <kbd className="ml-auto hidden rounded border border-line bg-surface px-1.5 py-px font-sans text-[11px] text-text-muted sm:inline">
          ⌘K
        </kbd>
      </button>
      ...
      <Link
        href="/help"
        className="hidden h-8 items-center gap-1.5 rounded-lg px-2.5 text-[12.5px] text-text-tertiary transition-colors hover:bg-surface-subtle hover:text-text-primary md:inline-flex"
      >
        <HelpIcon size={15} />
        Help
      </Link>
      ...
      <Link
        href="/account"
        aria-label="Account"
        className="ml-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-ink text-[12px] font-semibold text-text-inverse"
      >
        OP
      </Link>
    </header>
