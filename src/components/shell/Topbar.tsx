  ...
  return (
    <header className="flex h-[84px] shrink-0 items-center gap-2 bg-surface px-3 lg:px-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="hidden items-center gap-1.5 px-2 py-1 text-[11.5px] text-text-tertiary transition-colors hover:bg-surface-subtle hover:text-text-primary md:inline-flex"
      >
        {site.url}
      ...
      <button
        ...
        className={cx(
          "ml-auto flex h-8 items-center gap-2 bg-surface-subtle-subtle pl-2.5 pr-2 text-text-muted",
      ...
      >
        ...
        <kbd className="ml-auto hidden bg-surface px-1.5 py-px font-sans text-[10px] text-text-muted sm:inline">
          ⌘K
        </kbd>
      </button>
      ...
      <Link
        href="/help"
        className="hidden h-8 items-center gap-1.5 px-2.5 text-[11.5px] text-text-tertiary transition-colors hover:bg-surface-subtle hover:text-text-primary md:inline-flex"
      >
        <HelpIcon size={15} />
        Help
      </Link>
      ...
      <span className="relative">
        ...
        <span className="pointer-events-none absolute right-[7px] top-[6px] h-2 w-2 border-2 border-surface bg-accent" />
      </span>

      <Link
        href="/account"
        aria-label="Account"
        className="ml-0.5 flex h-8 w-8 items-center justify-center bg-ink text-[11.5px] font-semibold text-text-inverse"
      >
        OP
      </Link>
    </header>
