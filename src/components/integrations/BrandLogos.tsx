...
export function SlackLogo({ size = 22, className }: P) {
  return (
    <svg {...box(size)} className={className}>
      <path d="M13 29.4a3.9 3.9 0 1 1-3.9-3.9H13v3.9Zm2 0a3.9 3.9 0 0 1 7.8 0v9.7a3.9 3.9 0 0 1-7.8 0v-9.7Z" fill="#E01E5A" />
      <path d="M18.9 13a3.9 3.9 0 1 1 3.9-3.9V13h-3.9Zm0 2a3.9 3.9 0 0 1 0 7.8H9.1a3.9 3.9 0 0 1 0-7.8h9.8Z" fill="#36C5F0" />
      <path d="M35 18.9a3.9 3.9 0 1 1 3.9 3.9H35v-3.9Zm-2 0a3.9 3.9 0 0 1-7.8 0V9.1a3.9 3.9 0 0 1 7.8 0v9.8Z" fill="#2EB67D" />
      <path d="M29.1 35a3.9 3.9 0 1 1-3.9 3.9V35h3.9Zm0-2a3.9 3.9 0 0 1 0-7.8h9.8a3.9 3.9 0 0 1 0 7.8h-9.8Z" fill="#ECB22E" />
    </svg>
  );
}
...
export function HubspotLogo({ size = 22, className }: P) {
  return (
    <svg {...box(size)} className={className}>
      ...
      <path d="M31 20.5V16a2.8 2.8 0 1 0-3 0v4.5a8 8 0 0 0-3.4 1.4l-8-6.2a3 3 0 1 0-1.7 2.3l7.8 6a7.9 7.9 0 1 0 8.3-3.5Zm-3.3 12.9a4.2 4.2 0 1 1 0-8.4 4.2 4.2 0 0 1 0 8.4Z" fill="#fff" />
    </svg>
  );
}
...
export function GmailLogo({ size = 22, className }: P) {
  return (
    <svg {...box(size)} className={className}>
      <path d="M6 12.8 24 26l18-13.2V36a2 2 0 0 1-2 2h-4V21.5L24 30.4 12 21.5V38H8a2 2 0 0 1-2-2V12.8Z" fill="#4285F4" />
