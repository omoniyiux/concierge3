    ...
    >
      {chrome === "app" && (
        <div className="flex items-center gap-2 bg-surface-subtle px-3.5 py-2.5">
          ...
          <span className="ml-2 flex items-center gap-1.5 rounded-md bg-surface px-2 py-1 text-[11px] text-text-muted">
      ...
      {rules.map((r, i) => (
        <Card key={r.name} className="p-3.5">
          <div className="flex items-start gap-3">
            <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded bg-surface-subtle text-[10px] font-semibold tabular-nums text-text-tertiary">
              {i + 1}
            </span>
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-1.5">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-md bg-surface px-2 py-1 text-[11px] font-medium">
  ...
  return (
    <div className="flex bg-canvas">
      ...
      <div className="hidden w-[150px] shrink-0 flex-col border-r border-divider bg-surface py-3 sm:flex">
        {[
          ...
          <span
            key={label}
            className={cx(
              "relative mx-2 flex h-7 items-center gap-2 rounded-md px-2 text-[13.5px]",
      ...
      <div className="min-w-0 flex-1 p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-px overflow-hidden rounded-xl bg-surface-subtle bg-line sm:grid-cols-4">
          {headline.map((m) => (
